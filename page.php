                    ...
                    <div class="loginform1" id="loginform1">
                        <form>
                            <div class="contact">
                                ...
                                <input type="text" placeholder="Enter your username" name="username" id="username" class="contact_space">
                            </div>
                            <div class="contact">
                                <label>Password:</label>
                                <input type="password" placeholder="Enter your password" name="password"  id="password" class="contact_space"><br>
                            </div>
                            <div class="button">
